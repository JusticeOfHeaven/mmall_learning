...
public class UserController {
    ...
    /**
     * ResponseBody() 将返回结果自动序列化为json，配置在dispatcher-servlet.xml
     *
     * @param username
     * @param password
     * @param session
    ...
    @ResponseBody()
    public ServerResponse<String> checkValid(String str, String value) {
        return iUserService.checkValid(str, value);
    }
